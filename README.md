...
• 自动获取路网 / 水体 / 公园绿地 / POI 兴趣点
• 采集半径可选：3000m–20000m
• 本地缓存地图数据，再次生成同一城市更快

🎨 主题与颜色
• 20 种预设主题：北欧霜冻 / 沙漠玫瑰 / 赛博朋克霓虹 / 硫磺与极岩 / 复古航海 / 薰衣草薄雾 / 碳纤维 / 地中海之夏 / 皇家天鹅绒 / 森林苔藓 / 棉花糖 / 野兽派混凝土 / 暖阳深蓝 / 抹茶拿铁 / 红色警报 / 烫金黑曜石 / 深海深渊 / 樱花枝头 / 陶土大地 / 故障紫色
• 自定义 12 类颜色：背景 / 文字 / 渐变遮罩 / 水体 / 公园绿地 / POI / 高速公路 / 主要道路 / 次要道路 / 三级道路 / 居住区道路 / 其他街道
• 支持实时预览配色效果

✂️ 构图
• 8 种海报尺寸：iPhone / 1:1 方形 / 3:4 竖版 / 9:16 竖版 / 4:3 横版 / 16:9 横版 / A4 竖版 / A4 横版
• 自定义海报标题
• 顶部与底部渐变遮罩，提升海报留白和文字可读性

🔤 字体
• 支持上传自定义字体（TTF / OTF 格式）
• 自定义字体会应用到最终导出的海报标题中

⚙️ 渲染
• 使用 WASM 高速渲染高清地图海报
• Worker 多线程处理道路、水体、公园和 POI 数据
• 生成流程显示实时进度：检查缓存 / 获取地图数据 / 分片道路 / WASM 处理 / 准备渲染 / 导出文件

🖼️ 预览与图库
• 页面内实时地图预览
• 内置海报案例图库
• 图库支持自动横向滚动、点击放大、缩放和平移查看
